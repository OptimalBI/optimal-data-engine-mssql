CREATE TABLE [dbo].[dv_connection] (
	...
	[connection_db_type]  VARCHAR(50)		 CONSTRAINT [DF__dv_connection__connection_db_type] DEFAULT (('MSSQLServer')) NOT NULL,
    [version_number]      INT                CONSTRAINT [DF__dv_connection__version_number] DEFAULT ((1)) NOT NULL,
    [updated_by]          VARCHAR (128)      CONSTRAINT [DF__dv_connection__updated_by] DEFAULT (suser_name()) NULL,
	...
	CONSTRAINT [CK_dv_connection__connection_db_type] CHECK ([connection_db_type]='MSSQLServer' OR [connection_db_type]='Oracle')
);
