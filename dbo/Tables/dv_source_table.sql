CREATE TABLE [dbo].[dv_source_table] (
    ...
    CONSTRAINT [CK_dv_source_table__load_type] CHECK ([load_type]='Full' OR [load_type]='Delta'),
    CONSTRAINT [CK_dv_source_table__source_type] CHECK ([source_type]='BespokeProc' OR [source_type]='SourceTable' OR [source_type]='ExternalStage' OR [source_type]='LeftRightComparison'),
