...
AS 
	...
	INSERT INTO [dbo].[dv_link] ([link_name], [link_abbreviation], [link_schema], [link_database],[release_key])
	SELECT @link_name, @link_abbreviation, @link_schema, @link_database, @release_key
	
	-- Begin Return Select <- do not remove
	SELECT [link_key], [link_name], [link_abbreviation], [link_schema], [link_database],[release_key], [version_number], [updated_by], [updated_datetime]
	FROM   [dbo].[dv_link]
