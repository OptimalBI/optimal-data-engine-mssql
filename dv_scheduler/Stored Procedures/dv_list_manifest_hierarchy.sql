...
SELECT @RN = count(*) FROM [dv_scheduler].[fn_CheckManifestForCircularReference] (@vault_run_key)
if @RN > 0
   begin
   select * from [dv_scheduler].[fn_CheckManifestForCircularReference] (@vault_run_key)
