/*
Deployment script for ode_to_mssql_1
...
GO
:setvar DatabaseName "ode_to_mssql_1"
:setvar DefaultFilePrefix "ode_to_mssql_1"
...
CREATE LOGIN [SBLogin]
    WITH PASSWORD = N'OATG1DjYIwpCzOVm1eVH1ur+hvTfsn/3Sc2F1ylc7AI=', DEFAULT_LANGUAGE = [us_english], CHECK_POLICY = OFF;
...
GO
ALTER TABLE [dv_scheduler].[dv_schedule_source_table]
    ADD CONSTRAINT [CK_dv_schedule_source_table__queue] CHECK ([queue]='001' OR [queue]='001');
