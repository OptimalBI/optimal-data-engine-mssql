...
union SELECT dv_schema_name = cast('dbo'			as sysname), dv_table_name = cast('dv_source_system'			as sysname), dv_key_name = cast('system_key'				as sysname), dv_load_order = cast(30  as int)
...
union SELECT dv_schema_name = cast('dbo'			as sysname), dv_table_name = cast('dv_hub_column'				as sysname), dv_key_name = cast('hub_column_key'			as sysname), dv_load_order = cast(120 as int)
...
union SELECT dv_schema_name = cast('dbo'			as sysname), dv_table_name = cast('dv_satellite_column'			as sysname), dv_key_name = cast('satellite_column_key'		as sysname), dv_load_order = cast(160 as int)
)