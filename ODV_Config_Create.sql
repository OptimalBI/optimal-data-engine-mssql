/*
Deployment script for ODV_Config_20150924_1
...
GO
:setvar DatabaseName "ODV_Config"
:setvar DefaultFilePrefix "ODV_Config"
...
If not Exists (select loginname from master.dbo.syslogins where name = 'SBLogin')
Begin
...
CREATE TABLE [dbo].[dv_column] (
    ...
    [discard_flag]               BIT                NOT NULL,
    [deleted_column_flag]        BIT                NOT NULL,
    [release_key]                INT                NOT NULL,
    [version_number]             INT                NOT NULL,
    [updated_by]                 VARCHAR (30)       NULL,
    [update_date_time]           DATETIMEOFFSET (7) NULL,
...
GO
PRINT N'Creating [ODE_Release].[dv_release_001_001_001]...';
...
GO
PRINT N'Creating [ODE_Release].[dv_release_001_001_001].[PK_dv_release_001_001_001_Column]...';
...
GO
ALTER TABLE [dbo].[dv_source_table]
    ADD CONSTRAINT [DF__dv_source__updat__09A971A2] DEFAULT (user_name()) FOR [updated_by];
...
GO
ALTER TABLE [dbo].[dv_source_system]
    ADD CONSTRAINT [DF__dv_source__updat__02FC7413] DEFAULT (user_name()) FOR [updated_by];
...
GO
ALTER TABLE [dbo].[dv_satellite_column]
    ADD CONSTRAINT [DF__dv_satell__updat__3DE82FB7] DEFAULT (user_name()) FOR [updated_by];
...
GO
ALTER TABLE [dbo].[dv_satellite]
    ADD CONSTRAINT [DF__dv_satell__updat__778AC167] DEFAULT (user_name()) FOR [updated_by];
...
GO
ALTER TABLE [dbo].[dv_link]
    ADD CONSTRAINT [DF__dv_link__updated__6D0D32F4] DEFAULT (user_name()) FOR [updated_by];
...
GO
ALTER TABLE [dbo].[dv_hub_link]
    ADD CONSTRAINT [DF__dv_hub_li__updat__382F5661] DEFAULT (user_name()) FOR [updated_by];
...
GO
ALTER TABLE [dbo].[dv_hub_key_column]
    ADD CONSTRAINT [DF__dv_hub_ke__updat__32767D0B] DEFAULT (user_name()) FOR [updated_by];
...
GO
ALTER TABLE [dbo].[dv_hub_column]
    ADD CONSTRAINT [DF__dv_hub_co__updat__2BC97F7C] DEFAULT (user_name()) FOR [updated_by];
...
GO
ALTER TABLE [dbo].[dv_hub]
    ADD CONSTRAINT [DF__dv_hub__updated___5441852A] DEFAULT (user_name()) FOR [updated_by];
...
GO
ALTER TABLE [dbo].[dv_default_column]
    ADD CONSTRAINT [DF__dv_defaul__updat__2610A626] DEFAULT (user_name()) FOR [updated_by];
...
GO
ALTER TABLE [dbo].[dv_defaults]
    ADD CONSTRAINT [DF__dv_defaul__updat__1C873BEC] DEFAULT (user_name()) FOR [updated_by];
...
GO
ALTER TABLE [dbo].[dv_column_relationship]
    ADD CONSTRAINT [DF__dv_column__updat__14E61A24] DEFAULT (user_name()) FOR [updated_by];
...
GO
ALTER TABLE [dbo].[dv_column]
    ADD CONSTRAINT [DF__dv_column__delet__34C8D9D1] DEFAULT ((0)) FOR [deleted_column_flag];
...
GO
ALTER TABLE [dbo].[dv_column]
    ADD CONSTRAINT [DF__dv_column__updat__36B12243] DEFAULT (user_name()) FOR [updated_by];
...
GO
ALTER TABLE [dv_scheduler].[dv_schedule]
    ADD CONSTRAINT [DF__dv_schedule__updated___5441852A] DEFAULT (user_name()) FOR [updated_by];
...
GO
ALTER TABLE [dv_scheduler].[dv_source_table_hierarchy]
    ADD CONSTRAINT [DF_dv_source_table_hierarchy_updated_by] DEFAULT (user_name()) FOR [updated_by];
...
GO
ALTER TABLE [dv_scheduler].[dv_schedule_source_table]
    ADD CONSTRAINT [DF__dv_schedule_source_table__updated___5441852A] DEFAULT (user_name()) FOR [updated_by];
...
GO
ALTER TABLE [dv_release].[dv_release_master]
    ADD CONSTRAINT [DF_release.dv_release_master_updated_by] DEFAULT (user_name()) FOR [updated_by];
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '0b4b9534-0f2a-4d48-a7ca-7aa69e635300')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('0b4b9534-0f2a-4d48-a7ca-7aa69e635300')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'ea8d6eeb-1ba2-4aa1-839e-91ebc332adaa')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('ea8d6eeb-1ba2-4aa1-839e-91ebc332adaa')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'fa00fc6e-cf98-4c57-bb21-bc3267320fd8')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('fa00fc6e-cf98-4c57-bb21-bc3267320fd8')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '0ef4ee9b-d442-4c3f-ad45-27ecec213398')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('0ef4ee9b-d442-4c3f-ad45-27ecec213398')
