...
USING	(VALUES ('Hub','Object_Key',1,'','%','_key','int',NULL,NULL,NULL,NULL,0,1,0,0),
			    ...
			    ('Lnk','Object_Key',1,'','%','_key','int',NULL,NULL,NULL,NULL,0,1,0,0),
			    ...
			    ('Sat','Object_Key',1,'','%','_key','int',NULL,NULL,NULL,NULL,0,1,0,0),
			    ...
			    ('Dim','Object_Key',1,'','%','_key','int',NULL,NULL,NULL,NULL,0,1,0,0),
			    ...
			    ('Fact','Object_Key',1,'','%','_key','int',NULL,NULL,NULL,NULL,0,1,0,0)
